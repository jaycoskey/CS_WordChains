...
${OBJECTDIR}/word_chains.o: word_chains.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/word_chains.o word_chains.cpp

${OBJECTDIR}/word_link_writer.o: word_link_writer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/word_link_writer.o word_link_writer.cpp
...
${TESTDIR}/tests/newtestrunner.o: tests/newtestrunner.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/cygdrive/C/cygwin64/home/jmc/git/WordChains -include util.hpp -std=c++14 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/newtestrunner.o tests/newtestrunner.cpp


${TESTDIR}/tests/word_transform_tests.o: tests/word_transform_tests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/cygdrive/C/cygwin64/home/jmc/git/WordChains -include util.hpp -std=c++14 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/word_transform_tests.o tests/word_transform_tests.cpp
...
${OBJECTDIR}/util_nomain.o: ${OBJECTDIR}/util.o util.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/util_nomain.o util.cpp;\
	else  \
...
${OBJECTDIR}/word_chains_nomain.o: ${OBJECTDIR}/word_chains.o word_chains.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/word_chains_nomain.o word_chains.cpp;\
	else  \
...
${OBJECTDIR}/word_link_writer_nomain.o: ${OBJECTDIR}/word_link_writer.o word_link_writer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/word_link_writer_nomain.o word_link_writer.cpp;\
	else  \
